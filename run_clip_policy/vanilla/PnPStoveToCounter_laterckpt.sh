...
do
    ...
    python final_eval_clip_policy.py --checkpoint data/outputs/dec4/2025.12.03/22.38.27_train_diffusion_unet_clip/checkpoints/epoch_160_step_9498.ckpt \
        ...
        --n_train 52 \
        --n_test 1 \
        --prefix_dir dec4_na_na_16_laterckpt
done    