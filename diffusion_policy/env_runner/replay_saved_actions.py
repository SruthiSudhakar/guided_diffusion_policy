...
class RobomimicImageRunnerEval(BaseImageRunner):
    ...
    def __init__(self, 
        ...
        self.actions= np.load('/proj/vondrick3/sruthi/robots/diffusion_policy/data/curateddata/needle2/actions.npy', allow_pickle=True)
    ...
    def run(self, policy: BaseImagePolicy, classifier=None, guidance_scale=None, guided_towards=None):
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                #     pdb.set_trace()
                # env_action = self.actions[env_step_index,this_global_slice,:,:]
