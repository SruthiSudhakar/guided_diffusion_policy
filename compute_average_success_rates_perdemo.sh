...
for dir in "${dirs[@]}"; do
    python3 compute_average_success_rates_perdemo.py --base_dir data/outputs/jan19/2026.01.19/20.04.49_clip_allPnP/checkpoints/epoch_120_step_40897/feb7_expertllm_expert_fulltask_$dir
done
