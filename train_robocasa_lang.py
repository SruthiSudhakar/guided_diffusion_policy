...
CUDA_VISIBLE_DEVICES=1 python train.py \
    ...
    dataloader.batch_size=256 \
    val_dataloader.batch_size=256 \
    hydra.run.dir='data/outputs/${now:%Y.%m.%d}/${now:%H.%M.%S}_${name}_robocasalang_PnPSinkToCounter' \
    task.dataset.dataset_path=/proj/vondrick3/sruthi/robots/robocasa/datasets/v0.1/single_stage/kitchen_pnp/PnPSinkToCounter/2024-04-26_2/demo_gentex_im128_randcams_new_images.hdf5 \
    task.dataset_path=/proj/vondrick3/sruthi/robots/robocasa/datasets/v0.1/single_stage/kitchen_pnp/PnPSinkToCounter/2024-04-26_2/demo_gentex_im128_randcams_new_images.hdf5 \
    task.env_runner.dataset_path=/proj/vondrick3/sruthi/robots/robocasa/datasets/v0.1/single_stage/kitchen_pnp/PnPSinkToCounter/2024-04-26_2/demo_gentex_im128_randcams_new_images.hdf5 \
    task.env_runner.n_envs=1 \
    task.env_runner.n_train=1 \
    task.env_runner.n_test=1 
...
CUDA_VISIBLE_DEVICES=1 python train.py \
    ...
    hydra.run.dir='data/outputs/${now:%Y.%m.%d}/${now:%H.%M.%S}_${name}_robocasalang_PnPX' \
    task.dataset.dataset_path=/proj/vondrick3/sruthi/robots/robocasa/datasets/v0.1/combined/PnPX/demo_gentex_im128_randcams_new_images.hdf5 \
    task.dataset_path=/proj/vondrick3/sruthi/robots/robocasa/datasets/v0.1/combined/PnPX/demo_gentex_im128_randcams_new_images.hdf5 \
    task.env_runner.dataset_path=/proj/vondrick3/sruthi/robots/robocasa/datasets/v0.1/combined/PnPX/demo_gentex_im128_randcams_new_images.hdf5 \
    task.env_runner.n_envs=1 \
    task.env_runner.n_train=1 \
    task.env_runner.n_test=1 \
    task.env_runner.max_steps=500 \
