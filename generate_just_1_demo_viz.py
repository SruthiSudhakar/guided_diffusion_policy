...
def generate_visualization(args, demo_id):
    ...
    type_of_run_info = ""
    if "nov21_generate_dp_data_all_demos" in args.root_dir:
        type_of_run_info = "vanilla dp"
    elif "nov27_na_na_32" in args.root_dir:
        type_of_run_info = "vanilla dp - 32 steps executed"
    elif "nov27_trained_32_8" in args.root_dir:
        type_of_run_info = "llm - 8 steps executed"
    elif "nov27_trained_32_32" in args.root_dir:
        type_of_run_info = "llm - 32 steps executed"
    elif "dec1_trained_32_8" in args.root_dir:
        type_of_run_info = "llm - 8 steps executed"
    elif "dec1_trained_32_32" in args.root_dir:
        type_of_run_info = "llm - 32 steps executed"
...
<body>
    ...
    <div class="summary">
        <div class="stat">Total Videos: <span class="stat-value" style="color: var(--text-color)">{type_of_run_info}</span></div>
        <div class="stat">Total Videos: <span class="stat-value" style="color: var(--text-color)">{len(all_demos)}</span></div>
        <div class="stat">Total Runs: <span class="stat-value" style="color: var(--accent-color)">{len(demos_by_group)}</span></div>
    </div>
"""
